...
class Config(object):
    ...
    @staticmethod
    def merge_model_file(cfg, args, extra_dict):
        ...
        cfg_dict = Config._merge_a_into_b(extra_cfg_dict, cfg)
    ...
    def merge_cfg_file(cfg, args, extra_dict):
        ...
        if "main_log_dir" in args and args.main_log_dir is not None:
            cfg.pipeline.main_log_dir = args.main_log_dir
        if "dataset_path" in args and args.dataset_path is not None:
